...
import purchaseService, { PurchaseService } from '../../application/purchase.service';
import { CreatePurchaseInvoiceDto, PurchaseQueryDto, UpdatePurchaseStatusDto } from '../../application/dtos';

export class PurchaseController {
    private purchaseService: PurchaseService;

    constructor(service: PurchaseService = purchaseService) { // Default to singleton if not provided
